...
void gs_debug_real(const char* func, const char* file, int line, const char* format, ...);
...
void _gs_profile_log(const char* func, const char* note, const char* format, ...) G_GNUC_PRINTF(3, 4);
